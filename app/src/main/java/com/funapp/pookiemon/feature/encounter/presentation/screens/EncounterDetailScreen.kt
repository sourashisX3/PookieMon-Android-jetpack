...
fun EncounterDetailScreen(
    ...
    Scaffold(
        topBar = {
            AppTopBar(
                title = uiState.method?.name?.replaceFirstChar { it.uppercase() } ?: stringResource(R.string.pokemon_default),
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Text(
                                text = stringResource(R.string.explore_encounters),
                    ...
                    Card(
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            ...
                            Text(
                                text = "${stringResource(R.string.berry_growth_time)} ${method.order}",
                                style = MaterialTheme.typography.bodyMedium,
                                color = MaterialTheme.colorScheme.onSurfaceVariant,
                            )
                        }
