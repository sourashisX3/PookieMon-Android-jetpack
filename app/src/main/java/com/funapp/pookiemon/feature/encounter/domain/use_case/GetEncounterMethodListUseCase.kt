...
class GetEncounterMethodListUseCase @Inject constructor(
    ...
    suspend operator fun invoke(offset: Int = 0, forceRefresh: Boolean = false): ApiResult<List<EncounterMethod>> {
        return repository.getEncounterMethodList(PAGE_SIZE, offset, forceRefresh)
    }
}
