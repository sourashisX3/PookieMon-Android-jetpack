...
fun LocationDetailScreen(
    ...
    Scaffold(
        topBar = {
            AppTopBar(
                title = uiState.location?.name?.replaceFirstChar { it.uppercase() } ?: stringResource(R.string.pokemon_default),
                ...
                Column(
                    ...
                    Card(
                        ...
                        Column(modifier = Modifier.padding(16.dp)) {
                            Text(
                                text = loc.name.replaceFirstChar { it.uppercase() },
                            ...
                            Row {
                                Text(
                                    text = stringResource(R.string.explore_locations),
                        ...
                        Card(
                            ...
                            Column(modifier = Modifier.padding(16.dp)) {
                                ...
                                loc.areas.forEach { area ->
                                    Text(
                                        text = area.replaceFirstChar { it.uppercase() },
