...
import com.funapp.pookiemon.feature.home.presentation.components.PokemonCard
import com.funapp.pookiemon.feature.home.presentation.components.PokemonCardShimmer
...
fun HomeScreen(
    ...
    LaunchedEffect(shouldLoadMore) {
        if (shouldLoadMore) {
            viewModel.onEvent(HomeUiEvent.LoadMorePokemon)
        }
    }
    ...
    Scaffold(
        ...
        Box(
            ...
            PullToRefreshBox(
                ...
                onRefresh = { viewModel.onEvent(HomeUiEvent.LoadPokemon) },
